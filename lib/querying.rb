...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN characters ON series.id = characters.series_id GROUP BY COUNT(species) AS species_count ORDER BY species_count DESC LIMIT 1"
end
